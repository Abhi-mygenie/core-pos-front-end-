...
export const mockMenuItems = {
  ...
  bar: [
    { id: "b1", name: "Whiskey Sour", price: 450, type: "veg", glutenFree: true, jain: true, vegan: true, customizable: true, taxCategory: "alcohol" },
    ...
    { id: "b4", name: "Blue Lagoon", price: 350, type: "veg", glutenFree: true, jain: true, vegan: true, customizable: true, taxCategory: "alcohol" },
    { id: "b5", name: "Virgin Mojito", price: 180, type: "veg", glutenFree: true, jain: true, vegan: true, customizable: false, taxCategory: "food" },
    { id: "b6", name: "Long Island Iced Tea", price: 520, type: "veg", glutenFree: true, jain: true, vegan: true, customizable: true, taxCategory: "alcohol" },
    { id: "b7", name: "Margarita", price: 420, type: "veg", glutenFree: true, jain: true, vegan: true, customizable: true, taxCategory: "alcohol" },
