        ...
        {!isLoading && !isMissing && displayData && (
          <div className="border-t border-zinc-200 p-5 bg-zinc-50">
            <div className="space-y-2">
              ...
              {/*
                BUG-039 (May-2026): render a dedicated "Delivery Charge" row
                whenever the order carries one. Previously the modal had no
                delivery-charge row, and the "Tax (GST)" line below was
                computed as `amount − subtotal`, which mathematically bundled
                the delivery principal into the Tax cell (e.g. order 825844
                showed Tax (GST) = ₹101, which actually contained items GST +
                delivery ₹10 + GST-on-delivery + restaurant-level fees). The
                Tax line below now subtracts deliveryCharge before display so
                the Tax cell reflects only tax/fee components, not delivery.
              */}
