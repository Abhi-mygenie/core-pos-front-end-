        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {!isLoading && !loadError && detail && detail.isRoom === true && (
            <CollectPaymentPanel
              ...
              // BUG-425 Path A: override remainingRoomBalance with live GST-inclusive formula
              // (roomPrice + gstTax - advance - received). Avoids touching CollectPaymentPanel (R5).
              // OD-425-01 confirmed. Same formula as BUG-423 folio fix.
