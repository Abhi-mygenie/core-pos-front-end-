...
export default function RecipeManagementPanel() {
  ...
  const activeRecipes = useMemo( // BUG-457 OD-457-03: stable ref — must be before early return (hooks rules)
    () => sortRecipes({ standard: standardRecipes, sub: subRecipes, addon: addonRecipes }[activeTab]),
    [activeTab, standardRecipes, subRecipes, addonRecipes, sortRecipes]
  );
    ...
    <div data-testid="recipe-management-panel">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        {activeTab === 'aggregator-inventory' ? (
          ...
          <RecipeBulkEditor
            recipes={activeRecipes} // BUG-457 OD-457-03
