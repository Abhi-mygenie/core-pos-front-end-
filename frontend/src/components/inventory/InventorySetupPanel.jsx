...
function IngredientsTab() {
  ...
  // BUG-311 Layer 1: exact duplicate check — drives Save disabled + combobox amber border
                ...
                {showAddForm && (
                  <tr className="border-b border-slate-100 bg-green-50/30" data-testid="ingredient-add-row">
                    <td className="py-2 px-4">
                      {/* BUG-311 Layer 1: typeahead combobox replaces plain Input */}
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center justify-center gap-1">
                          <Button size="sm" variant="outline" onClick={addIngredient}
                            ...
                            data-testid="save-new-ingredient">Save</Button>{/* BUG-311 Layer 1: disabled on exact duplicate */}
