...
// BUG-247: React.memo prevents re-render on parent typeahead state changes
function VendorSuggestionCell({ ranking, selectedVendorId, onChange, ingredientId }) {
...
export default React.memo(VendorSuggestionCell); // BUG-247
