            ...
            <table className="w-full text-left" style={{ minWidth: 1140 }}>
              <thead>
                <tr className="bg-slate-50/80">
                  ...
                  {['Ingredient', 'On-Hand', 'Status', 'Projected Need', 'Gap', 'Qty to Buy *', 'Rate', 'Vendor * (suggested)', ''].map((h, i) => (
                  ...
                  return (
                    <tr key={`${r.ingredient_id}-${ix}`} className={`border-b border-slate-50 hover:bg-slate-50/40 ${rowBg(r)}`} data-testid={`plan-row-${r.ingredient_id}`}>
                      ...
                      <td className="py-2 px-3">
                        ...
                        {r.suggestedRate && !r.rate && <div className="text-[10px] text-blue-500 font-medium mt-0.5">last: ₹{r.suggestedRate}</div>}
                      </td>
                      <td className="py-2 px-3">
