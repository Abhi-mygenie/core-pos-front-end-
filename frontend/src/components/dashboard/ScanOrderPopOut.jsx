...
// Locked predicate — Wave 6 simplification (2026-05-17):
// fOrderStatus === 7 (YTC) is exclusively for web/scan orders.
// POS orders never go through a "Yet to Confirm" step.
// No need to check orderFrom — the status itself is proof of web origin.
