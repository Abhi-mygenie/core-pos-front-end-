...
const ChannelColumnsLayout = ({
  ...
  // CR (May-2026) channel-view stability: when set to 'channel' the per-
  // column renderer uses a status-independent stable sort. When 'status'
  // it preserves the existing status-priority sort byte-for-byte. Default
  // 'channel' preserves the new owner-approved behaviour for any legacy
  ...
  // BUG-372: Shift/Merge table handlers
  onTableShift,
  onMergeOrder,
  // Permissions
  hasPermission,
