...
import { 
  ...
  LayoutGrid, List, Columns, Rows, LineChart
} from "lucide-react";
...
const sidebarMenuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "rooms", label: "Room Orders", path: "/reports/rooms" },
  ...
  // show to all). Will be added in Phase 4 hardening (S39).
  {
    ...
    children: [
      ...
      { id: "insights-items", label: "Items & Menu", path: "/reports-module/items" },
...
const Sidebar = ({ 
  ...
  const VISIBLE_SECTIONS = new Set(['dashboard', 'reports', 'insights', 'credit', 'menu-management', 'visibility-settings']);
