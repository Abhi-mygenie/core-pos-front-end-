  ...
  useEffect(() => {
    ...
    maxRedeemableRef.current = setTimeout(async () => {
      ...
      try {
        ...
        // Auto-apply: check loyalty when CRM says discount is available
        if (!result.error && result.maxDiscountValue > 0) {
          setUseLoyalty(true);
        } else {
          setUseLoyalty(false);
        }
    ...
    <div className="flex flex-col h-full" data-testid="collect-payment-panel">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div
          ...
          style={{ borderColor: COLORS.borderGray, opacity: (BUG108_FLAGS.couponLive && selectedCoupon) ? 0.6 : 1 }}
        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex gap-2 flex-1 justify-end">
              <select
                ...
                disabled={BUG108_FLAGS.couponLive && selectedCoupon !== null}
          ...
          {BUG108_FLAGS.couponLive && selectedCoupon && (
        ...
        {customer && restaurantSettings?.isCoupon && (() => {
          ...
          const helperText = !BUG108_FLAGS.couponLive
            ? BUG108_COPY.couponDisabledHelper
            : isManualActive
              ...
              <div className="pt-2 border-t" style={{ borderColor: COLORS.borderGray }}>
                ...
                {showRoomService && (
                  <div className="mt-1 mb-1 text-xs space-y-2" style={{ backgroundColor: `${COLORS.lightBg}` }}>
                    ...
                    <div className="px-3 pt-2 border-t" style={{ borderColor: COLORS.borderGray, opacity: (BUG108_FLAGS.couponLive && selectedCoupon) ? 0.6 : 1 }}>
                    ...
                    {customer && restaurantSettings?.isCoupon && (() => {
                      ...
                      const helperTextInline = !BUG108_FLAGS.couponLive
                        ? BUG108_COPY.couponDisabledHelper
