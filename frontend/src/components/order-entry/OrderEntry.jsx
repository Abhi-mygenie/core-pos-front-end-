          ...
          {showPaymentPanel ? (
            <CollectPaymentPanel
              ...
              onPrintBill={async (overrides) => {
                ...
                try {
                  ...
                  await printOrder(printOrderId, 'bill', null, order, restaurant?.serviceChargePercentage || 0, overrides);
              ...
              onPaymentComplete={async (paymentData) => {
                ...
                // in OrderContext — NO overrides from CollectPaymentPanel local state.
                //
                ...
                //   5. printOrder(..., no overrides) — buildBillPrintPayload default branch maps socket fields
                ...
                try {
                  ...
                  if (paymentData.isTransferToRoom && paymentData.roomId) {
                    ...
                    // BUG-273 (Session 16): auto-print NOT fired here. Per product contract,
                    // auto-bill is scoped to new-order only. Manual "Print Bill" button in
                    // CollectPaymentPanel handles printing for this scenario.
                    setIsPlacingOrder(true);
            ...
            <>
              ...
              >
                ...
                {/* Split Bill Button - Only for dine-in/walk-in placed orders with 2+ items (not takeaway/delivery/prepaid) (BUG-270) */}
                {placedOrderId && cartItems.filter(i => i.placed).length >= 2 && orderType !== 'takeAway' && orderType !== 'delivery' && !isPrepaid && (
                  <button
