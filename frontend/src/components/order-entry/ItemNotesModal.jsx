...
import { itemLevelPresets, getCustomerPreferences } from "../../data";

const ItemNotesModal = ({ item, onClose, onSave, initialNotes = [], customerId = null }) => {
  const [selectedNotes, setSelectedNotes] = useState(initialNotes);
  const [customNote, setCustomNote] = useState("");

  // Get customer preferences if available
  const customerData = customerId ? getCustomerPreferences(customerId, "item") : null;
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          {customerData ? (
            ...
            <div>
              ...
              >
                No customer linked. Add customer to see preferences.
              </div>
            </div>
          )}
        </div>
