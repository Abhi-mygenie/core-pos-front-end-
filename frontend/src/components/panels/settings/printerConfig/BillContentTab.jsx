// CR-133: Bill Content tab — restaurant info (read-only), footer, QR codes, display + Windows options
...
export const BillContentTab = ({ config, update }) => (
  <div data-testid="bill-content-tab">
    ...
    <div className="flex items-center gap-3 p-3 rounded-lg mb-4" style={{ backgroundColor: "#F9FAFB", border: `1px solid ${COLORS.borderGray}` }} data-testid="restaurant-info-banner">
