...
// (CR-133 amendment removed this section; owner confirmed printer-agent-config is the correct API)
...
export const AutoPrintTab = ({ config, update }) => {
  ...
  <div data-testid="autoprint-tab">
    ...
    {/* BUG-318: Aggregator Orders section — saves to printer-agent-config API (correct) */}
