    ...
    <div className="flex flex-col h-full" data-testid="product-form">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="mb-4">
          ...
          {/* BUG-375: Zomato image upload — aggregator food only (symmetrical fix to BUG-327 for Swiggy) */}
          {menuType === 'Aggregator' && (
          <div className="py-1.5">
            <label className="block text-xs font-medium mb-1" style={{ color: COLORS.grayText }}>Zomato Image</label>
