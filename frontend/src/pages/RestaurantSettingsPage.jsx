            ...
            <div data-testid="step-4-content">
              ...
              <SectionCard title="Order Workflow" desc="Control how orders move through your kitchen">
                <div className="grid grid-cols-2 gap-4 mb-4">
                  {/* BUG-289: rename options to operational workflow labels; remove value 3 (Preparing); update hint */}
                  <SelectInput label="Default Order Status" value={s4.defOrdStatus} onChange={(v) => updateStep('step4', 'defOrdStatus', parseInt(v))} options={[{ value: 1, label: 'Ready (Send To kitchen)' }, { value: 2, label: 'Serve (Send to waiter)' }, { value: 4, label: 'Accept (Send to Kot Manager)' }, { value: 5, label: 'Bill (Send to Cashier)' }]} hint="Order flow configuration" />
              ...
              <SectionCard title="Display Preferences">
                ...
                <Toggle label="Show Scan Pop Up" hint="Show scan order popup on dashboard" checked={s4.showScanPopup} onChange={(v) => updateStep('step4', 'showScanPopup', v)} /> {/* CR-056 */}
                <div className="mt-4">
