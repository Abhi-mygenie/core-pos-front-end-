            ...
            <div data-testid="step-2-content">
              ...
              <SectionCard title="Payment Methods" desc="How can customers pay? Select all accepted methods.">
                ...
                <div className="grid grid-cols-2 gap-4 mt-5">
                  ...
                  <SelectInput label="Order Payment Type" value={s2.orderPaymentType} onChange={(v) => updateStep('step2', 'orderPaymentType', v)} options={[{ value: 'both', label: 'Both (Pre & Post)' }, { value: 'pre', label: 'Pre-payment only' }, { value: 'post', label: 'Post-payment only' }]} />
                </div>
