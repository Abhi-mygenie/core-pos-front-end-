            ...
            <div data-testid="step-1-content">
              ...
              <SectionCard title="Restaurant Identity" desc="Core identity information">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <SelectInput label="Restaurant Type" value={s1.restaurantFor} onChange={(v) => updateStep('step1', 'restaurantFor', v)} options={[{ value: 'Normal', label: 'Normal' }, { value: 'Hotel', label: 'Hotel' }]} testId="select-restaurant-for" />
