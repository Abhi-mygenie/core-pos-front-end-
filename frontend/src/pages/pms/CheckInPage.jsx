              ...
              {!form ? (
                ...
                <div className="bg-white rounded-xl border border-[#E5E5E5] overflow-hidden">
                                ...
                                {crmDocs.slice(0, 3).map((doc, i) => (
                                  ...
                                  >
                                    ...
                                    <div className="absolute inset-0 flex flex-col justify-end p-1"
                                      ...
                                      <span className="inline-flex items-center gap-0.5 text-[8px] font-bold px-1 py-0.5 rounded-full text-white"
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    {/* BUG-419: Corp/B2B moved above Room Assignment per OD-419-01 */}
                    <div>
