...
import { ChevronLeft, User, FileText, Utensils, CreditCard, Clock, AlertTriangle } from 'lucide-react';
...
export default function GuestFolioPage() { // CR-364
  ...
  // Live room balance: prefer room_payment_summary figure; fall back to balancePayment
