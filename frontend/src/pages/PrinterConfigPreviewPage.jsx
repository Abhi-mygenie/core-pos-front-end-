...
const AutoPrintTab = () => (
  <div data-testid="autoprint-tab">
    ...
    {/* BUG-318: Aggregator Orders section */}
    <SectionTitle title="Aggregator Orders" />
    <Toggle label="Auto-print KOT" hint="Print KOT automatically when aggregator order is accepted" on={false} testId="aggregator-auto-kot-toggle" />
    <Toggle label="Auto-print Bill" hint="Print bill automatically at the selected stage" on={false} testId="aggregator-auto-bill-toggle" />
  </div>
);
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 12px', marginBottom: 12 }}>
        <div>
          ...
          <select style={{ width: '100%', fontSize: 11, padding: '6px 8px', border: `1px solid ${C.border}`, borderRadius: 7 }}>
            {['Montserrat','Roboto','Poppins','Ubuntu','Open Sans','Lato','Oswald','Helvetica (Sans Serif)','Times New Roman','Courier','Gujarati'].map(f => <option key={f}>{f}</option>)}
          </select>
        </div>
        <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
        ...
        <div style={{ background: '#F0FFF4', borderRadius: 10, padding: '10px 12px', border: `1px solid ${C.green}30` }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
            ...
            <input type="number" defaultValue={30} min={1} style={{ width: 48, fontSize: 11, padding: '3px 6px', border: `1px solid ${C.border}`, borderRadius: 6, textAlign: 'center' }} />
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
            <span style={{ fontSize: 10, color: C.gray }}>UPI QR Size</span>
            <input type="number" defaultValue={25} min={1} style={{ width: 48, fontSize: 11, padding: '3px 6px', border: `1px solid ${C.border}`, borderRadius: 6, textAlign: 'center' }} />
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
            <span style={{ fontSize: 10, color: C.gray }}>Feedback QR</span>
            <input type="number" defaultValue={25} min={1} style={{ width: 48, fontSize: 11, padding: '3px 6px', border: `1px solid ${C.border}`, borderRadius: 6, textAlign: 'center' }} />
          </div>
          <div style={{ fontSize: 10, color: C.gray, marginTop: 4 }}>Min: 1</div>{/* BUG-317 */}
        </div>
      </div>
