...
import { ArrowLeft, Calendar, TrendingUp, TrendingDown, DollarSign, Receipt, Download, Loader2 } from 'lucide-react';
...
export default function PLReportPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const res = await getProfitLossReport(fromDate, toDate);
      setData(res);
    } catch (err) {
