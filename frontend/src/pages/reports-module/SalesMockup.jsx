...
const SalesMockup = () => {
  ...
  const analytics = useMemo(() => {
    ...
    // Only paid/settled orders (f_order_status === 6) — owner directive 2026-06-05
    ...
    const totalTax = revenueOrders.reduce((s, r) => s + (r.gstAmount || 0) + (r.vatAmount || 0), 0);
    ...
    revenueOrders.forEach((o) => {
      const date = o.orderDate || 'Unknown'; // DD/MM/YYYY
    ...
    revenueOrders.forEach((o) => {
      ...
      let ch = 'Dine-In';
      if (ot.includes('delivery') || ot.includes('home_delivery')) ch = 'Delivery';
    ...
    revenueOrders.forEach((o) => {
      ...
      const pmKey = pm.toLowerCase().includes('upi') ? 'UPI'
        ...
        : pm.toLowerCase().includes('partial') ? 'Partial'
        : pm;
