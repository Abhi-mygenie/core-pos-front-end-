...
export const useSocketEvents = () => {
  ...
  const { addOrUpdateProduct, removeProduct } = useMenu();
  ...
  const actionsRef = useRef({ addOrder, updateOrder, removeOrder, getOrderById, updateTableStatus, setTableEngaged, setOrderEngaged, mergeRunningOrders, addOrUpdateProduct, removeProduct });
  
  // Update ref when context functions change
  useEffect(() => {
    actionsRef.current = { addOrder, updateOrder, removeOrder, getOrderById, updateTableStatus, setTableEngaged, setOrderEngaged, mergeRunningOrders, addOrUpdateProduct, removeProduct };
  }, [addOrder, updateOrder, removeOrder, getOrderById, updateTableStatus, setTableEngaged, setOrderEngaged, mergeRunningOrders, addOrUpdateProduct, removeProduct]);
