...
// BUG-316 FIX: APPROVED_FONTS is the product-defined list — always used regardless of API response
...
export const fromAPI = (data) => {
  ...
  return {
    ...
    options: {
      ...
      areaOptions: [],   // CR-167: populated by getAreaOptions() on PrinterAgentConfigView mount
      ...
      // BUG-316 FIX: always use APPROVED_FONTS — product-defined list, API available_fonts ignored
