  ...
  settingsResponse: (data) => {
    ...
    return {
      ...
      step4: {
        ...
        showScanPopup: basic.show_scan_popup != null ? toBool(basic.show_scan_popup) : true, // CR-056: default ON · BUG-FIX: backend moved show_scan_popup from advanced→basic (2026-08-08 dedup)
  ...
  settingsPayload: (formState) => {
    ...
    return {
      basic: {
        ...
        show_scan_popup: s4.showScanPopup ? 1 : 0,   // CR-056 · BUG-FIX: moved to basic (was advanced) — backend dedup 2026-08-08
      ...
      advanced: {
        ...
        // show_scan_popup moved to basic{} — backend dedup 2026-08-08 (was: show_scan_popup: s4.showScanPopup ? 1 : 0)
