...
export const getFrontDeskRules = async () => {
  ...
  return {
    ...
    autoPrintCheckinReceipt: Boolean(basic.auto_print_checkin_receipt ?? basic['pms.auto_print_checkin_receipt'] ?? false), // CR-385 M3 D32 (read-only; M7 writes only the two rules)
  };
};
