...
import { LocalPrinterSetupView } from "./components/panels/settings/localPrinter/LocalPrinterSetupView"; // CR-161/CR-351
...
import FrontDeskWorkstationPage from './pages/pms/FrontDeskWorkstationPage'; // CR-385 M0
        ...
        <div className="App">
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/local-printer-setup" element={<LocalPrinterSetupView />} />  {/* CR-161/CR-351 */}
              ...
              <Route path="/pms/front-desk-v2"    element={<ProtectedRoute><FrontDeskWorkstationPage /></ProtectedRoute>} /> {/* CR-385 M0 */}
            </Routes>
          </BrowserRouter>
          <Toaster />
