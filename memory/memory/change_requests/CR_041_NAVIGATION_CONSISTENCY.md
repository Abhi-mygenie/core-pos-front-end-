...
- **Option A:** Everything becomes a full-page route (like Restaurant Setup / Reports) ✅ **OWNER SELECTED (2026-06-15)**
- ~~Option B: Everything becomes a slide-over panel~~
- ~~Option C: Defined rules~~
- ~~Option D: Owner picks per-item~~

**Decision:** All sidebar items will open as **full-page routes**, matching the Insights reports pattern. Slide-over panels (Menu Management, Credit Management, Settlement) will be migrated to standalone full-page routes.
