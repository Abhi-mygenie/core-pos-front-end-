# BUG Legacy Retro Summary — BUG-009
...
Rounding Off — Inverted Logic (₹1.06 Rounds to ₹2 Instead of ₹1)

## 3. Original April-2026 fix narrative (from master tracker)

FIXED (Apr-2026) — fractional-part-based rounding
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-009)
...
— End of BUG-009 Legacy Retro Summary —
