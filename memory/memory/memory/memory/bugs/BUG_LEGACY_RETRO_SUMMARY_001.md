# BUG Legacy Retro Summary — BUG-001
...
Prepaid Auto Bill Print — Payload Missing Tip and Discount

## 3. Original April-2026 fix narrative (from master tracker)

Fixed (Apr-2026) — autoPrintOverrides now passed with live paymentData values
...
`OrderEntry.jsx`, `CollectPaymentPanel.jsx`, `orderService.js`, `orderTransform.js`
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-001)
...
— End of BUG-001 Legacy Retro Summary —
