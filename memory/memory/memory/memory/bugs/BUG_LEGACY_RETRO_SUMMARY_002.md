# BUG Legacy Retro Summary — BUG-002
...
Postpaid Collect Bill — Auto Bill Print Not Triggered (no order-temp-store call)

## 3. Original April-2026 fix narrative (from master tracker)

Fixed (Apr-2026) — AutoPrintCollectBill path added after successful collect-bill
...
`OrderEntry.jsx`, `orderService.js`, `orderTransform.js`, `constants.js`
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-002)
...
— End of BUG-002 Legacy Retro Summary —
