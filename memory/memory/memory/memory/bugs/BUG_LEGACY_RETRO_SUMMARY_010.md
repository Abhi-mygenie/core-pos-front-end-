# BUG Legacy Retro Summary — BUG-010
...
Discount and Tip Fields — No Programmatic Max Validation (Allows >100% Discount)

## 3. Original April-2026 fix narrative (from master tracker)

FIXED (Apr-2026) — JS-enforced validation added
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-010)
...
— End of BUG-010 Legacy Retro Summary —
