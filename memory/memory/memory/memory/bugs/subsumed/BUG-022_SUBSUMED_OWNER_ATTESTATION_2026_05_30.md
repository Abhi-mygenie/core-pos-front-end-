# BUG-022 — Owner Smoke Attestation (subsumed)

**Bug:** BUG-022
**Title:** Cancelled Item — Not Shown as Strikethrough in Collect Bill Page 'ITEMS' List
...
The project owner attests, on 2026-05-30, that the defect behaviour originally tracked under BUG-022 **no longer reproduces in the current production build**. The owner has waived code-level identification of the subsuming CR / commit.
