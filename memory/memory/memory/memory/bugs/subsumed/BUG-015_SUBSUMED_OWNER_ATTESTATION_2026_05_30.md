# BUG-015 — Owner Smoke Attestation (subsumed)

**Bug:** BUG-015
**Title:** Loyalty, Coupon Code, and Wallet Shown on Collect Bill — Feature Flags Not Gating Visibility
...
The project owner attests, on 2026-05-30, that the defect behaviour originally tracked under BUG-015 **no longer reproduces in the current production build**. The owner has waived code-level identification of the subsuming CR / commit.
