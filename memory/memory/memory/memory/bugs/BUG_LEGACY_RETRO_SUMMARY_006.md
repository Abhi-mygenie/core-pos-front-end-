# BUG Legacy Retro Summary — BUG-006
...
Service Charge Calculated Before Discount (Should Be After Discount, Then Taxes)

## 3. Original April-2026 fix narrative (from master tracker)

Fixed (Apr-2026) — AD-101 implemented, GST extended to SC/tip/delivery
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-006)
...
— End of BUG-006 Legacy Retro Summary —
