...
| BUG-028 | Service Charge Auto-Added on Bill Even When Auto Service Charge Toggle Is Off | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-029 | Prepaid Order — After Settling Bill, POS Returns to Previous Order's Edit Screen Instead of New Order | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-030 | Cancelled KOT Not Received After Item Cancellation | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-031 | Out-of-Menu Order Item Not Added to Menu Management | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-032 | Back-End Order ID Displayed Instead of Restaurant Order ID | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-033 | Cancellation Notification Says "Order Updated" Instead of "Order Cancelled" | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-034 | Inconsistent Notification Tone When Placing / Serving Orders | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-035 | Dynamic Price Feature Missing in New POS (parity gap with old POS) | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-036 | PG-Paid Scan Order Stays on Dashboard After Mark-Served (prepaid branch mismatched; probable `payment_type` case-mismatch — tracked in CR-011) | **Open — Parked for validation (May-2026)** | Not Started | `pages/DashboardPage.jsx` `handleMarkServed`, `api/transforms/orderTransform.js:191`, `api/transforms/reportTransform.js` (multiple) — see `/app/memory/change_requests/CR_011_PG_SCAN_SERVE_PAYMENTTYPE_CASE_MISMATCH.md` |
| BUG-037 | Scan Order Confirm Fails When Default Configuration Is "Delivered" | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
...
| BUG-042 | Hold Order — Payment Collection Fails With UPI Payment Method | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-043 | Room Orders Report — Wrongly Shows Discount Column / Value | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-044 | Free / Available Table Still Shows Old Order Items Until Page Refresh | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-045 | New Web / Scan & Order Popup — View Order & Reject Actions Not Working; Item Price Shows ₹0.00 | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-046 | Editable Delivery Charge Accepted But Not Reflected in Order Total / Collect Bill Amount | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-047 | Order Placed From "Mayur's Kitchen" But Buzzer Notification Appears For "18 March" | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
| BUG-048 | Room Orders Report — Discount Column Wrongly Shows Previous Outstanding After Full Payment; Total Inflates (₹9,999 → ₹16,665) | **Closed — Smoke Pass** | Implemented & Verified | Fixed via owner-locked calculation model; smoke 7/7 pass; see `/app/memory/bugs/BUG_048_SMOKE_SIGNOFF.md` |
| BUG-049 | PayLater Payment Leaves "NA" On Available Table Card | **Open — Intake Created** | Not Started | Intake only — to be analyzed |
