# BUG Legacy Retro Summary — BUG-004
...
Split Bill — Total Amount Wrong in Equally and By Person

## 3. Original April-2026 fix narrative (from master tracker)

Fixed (Apr-2026) — uses `grandTotal` from CollectPaymentPanel as authoritative total
...
`SplitBillModal.jsx`, `OrderEntry.jsx`, `CollectPaymentPanel.jsx`
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-004)
...
— End of BUG-004 Legacy Retro Summary —
