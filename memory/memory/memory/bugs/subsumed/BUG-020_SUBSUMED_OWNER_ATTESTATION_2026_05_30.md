# BUG-020 — Owner Smoke Attestation (subsumed)

**Bug:** BUG-020
**Title:** Final Bill Total — Unwanted Round-Off on Grand Total (₹49.50 → ₹50)
...
The project owner attests, on 2026-05-30, that the defect behaviour originally tracked under BUG-020 **no longer reproduces in the current production build**. The owner has waived code-level identification of the subsuming CR / commit.
