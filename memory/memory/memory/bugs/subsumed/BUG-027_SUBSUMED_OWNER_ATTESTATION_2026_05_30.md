# BUG-027 — Owner Smoke Attestation (subsumed)

**Bug:** BUG-027
**Title:** Room Check-In — Payment Method Not Captured for 'Advance' Amount
...
The project owner attests, on 2026-05-30, that the defect behaviour originally tracked under BUG-027 **no longer reproduces in the current production build**. The owner has waived code-level identification of the subsuming CR / commit.
