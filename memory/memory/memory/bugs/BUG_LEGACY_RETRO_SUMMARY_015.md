# BUG Legacy Retro Summary — BUG-015
...
Loyalty, Coupon Code, and Wallet Shown on Collect Bill — Feature Flags Not Gating Visibility

## 3. Original April-2026 fix narrative (from master tracker)

FIXED (Apr-2026) — gated by profile settings
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-015)
...
— End of BUG-015 Legacy Retro Summary —
