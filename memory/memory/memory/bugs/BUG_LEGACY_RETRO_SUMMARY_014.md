# BUG Legacy Retro Summary — BUG-014
...
GST Not Applied on Tip Amount

## 3. Original April-2026 fix narrative (from master tracker)

Closed — confirmed working by user (Apr-2026)
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-014)
...
— End of BUG-014 Legacy Retro Summary —
