# BUG-071 — Owner Smoke Sign-off — 2026-05-30

**Bug:** UI and Bills Should Show User-Facing Order ID, Not Database Order ID
**Sprint:** POS 2.0
...
**Evidence file:** `memory/bugs/smoke_signoffs/evidence_2026_05_30/BUG_071_user_order_id.png`

![Smoke screenshot](../memory/bugs/smoke_signoffs/evidence_2026_05_30/BUG_071_user_order_id.png)
...
- `memory/change_requests/final_sprint_reconciliation/POS2_0_WAVE_5_CODE_DIFF_PREVIEW_BUG_071_2026_05_17.md`
- `memory/change_requests/final_sprint_reconciliation/POS2_0_WAVE_5_IMPLEMENTATION_REPORT_BUG_071_2026_05_17.md`
