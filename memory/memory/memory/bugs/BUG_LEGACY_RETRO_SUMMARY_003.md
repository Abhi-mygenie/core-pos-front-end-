# BUG Legacy Retro Summary — BUG-003
...
Credit on Walk-in — Name Field Auto-Fills “Walk-In”

## 3. Original April-2026 fix narrative (from master tracker)

Fixed (Apr-2026) — uses `customerName` (actual name) instead of display label
...
`OrderEntry.jsx`, `CollectPaymentPanel.jsx`, `orderTransform.js`
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-003)
...
— End of BUG-003 Legacy Retro Summary —
