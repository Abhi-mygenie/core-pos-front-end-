...
7. Verified compile, local (`http://localhost:3000` → 200) and public preview (`https://pos-frontend-deploy-18.preview.emergentagent.com` → 200) responses. Login screen renders with MyGenie branding.

## 4. Environment Variables (`/app/frontend/.env`)

```
REACT_APP_BACKEND_URL=https://pos-frontend-deploy-18.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- `curl https://pos-frontend-deploy-18.preview.emergentagent.com` → `HTTP 200`.
...
- **Public preview:** https://pos-frontend-deploy-18.preview.emergentagent.com
