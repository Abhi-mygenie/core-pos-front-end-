...
- [ ] All Group A passed (Settle does not print)
- [ ] All Group B passed (explicit print works)
- [ ] All Group C passed (Collect Bill auto-print correct)
- [ ] All Group D passed (Place Order print correct)
- [ ] All Group E passed (Handover = intended bill, Settle = no print)
- [ ] All Group F passed (Ready/Serve/Dispatch no print)

**If all checked:** `prod_bug_002_no_code_fix_needed_runtime_QA_passed`

**If any unchecked:** `prod_bug_002_runtime_QA_failed_fix_planning_needed` — attach evidence per §5.
