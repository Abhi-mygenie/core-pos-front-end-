...
The app is already deployed at `https://bug-104-credit.preview.emergentagent.com/` (hot-reload). Run the following cases and verify Bill Summary UI + Network tab BILL_PAYMENT body + printed bill:
