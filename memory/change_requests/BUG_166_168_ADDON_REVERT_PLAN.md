...
**Date:** 2026-07-12
**Status:** ~~PENDING OWNER GO~~ **CANCELLED — OWNER DECISION 2026-07-11: KEEP THE FIX**
**Reason (original):** Owner confirmed previous logic was correct for addon quantity.
**Owner override (2026-07-11):** "NO, keep the fix" — `addon_amount × qty` logic is correct and stays. This revert plan is void and must not be actioned.

---

> **ARCHIVED — DO NOT ACTION**
> BUG-166 fix (`addonAmount × qty` at L704 + L1493) is permanent.
> BUG-168 display fix is permanent.
> All 11 code changes listed below are KEPT as-is.
> This document is preserved for audit trail only.
