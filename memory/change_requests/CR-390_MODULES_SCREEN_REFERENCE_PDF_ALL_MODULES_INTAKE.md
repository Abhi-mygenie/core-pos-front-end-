...
| OD-390-14b | Disclaimer placement & wording for client PDFs | (a) footer on every page: "Sample data shown for illustration · © MyGenie" · (b) cover only · (c) both — **recommend (c)**: one line on cover ("All figures are sample data for illustration") + short footer on every page | OPEN |
