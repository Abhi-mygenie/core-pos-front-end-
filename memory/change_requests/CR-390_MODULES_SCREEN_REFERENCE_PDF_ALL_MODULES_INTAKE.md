...
| DC | **Day Closure & Settlement** | `/day-closure`, `/settlement/preview`, `/reports-module/cashier-settlement`, `/reports-module/settlement`, `/credit` (credit collection at close — confirm) | **CONFIRMED** (contents — OD-390-10 OPEN) |
