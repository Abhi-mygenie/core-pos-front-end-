...
- Route reachability confirmed — `https://bug-104-credit.preview.emergentagent.com/reports/audit` returns 200 and falls back to login (expected for a `ProtectedRoute`).
