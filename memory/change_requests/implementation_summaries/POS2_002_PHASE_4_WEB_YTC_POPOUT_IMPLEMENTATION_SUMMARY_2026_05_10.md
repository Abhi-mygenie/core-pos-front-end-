...
`https://bug-104-credit.preview.emergentagent.com/` → HTTP 200. Frontend supervisor `RUNNING`. (Full Q-1..Q-17 live smoke deferred to the QA agent — see §6.)
...
| Live preview | ✅ — `https://bug-104-credit.preview.emergentagent.com/` returns HTTP 200; supervisor `RUNNING` |
