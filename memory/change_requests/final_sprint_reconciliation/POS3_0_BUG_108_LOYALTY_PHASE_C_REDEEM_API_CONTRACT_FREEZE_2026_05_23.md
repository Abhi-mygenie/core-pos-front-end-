...
7. POS frontend state:
   ...
   - `/app/frontend/.env` — `REACT_APP_CRM_BASE_URL=https://crm-may-branch.preview.emergentagent.com/api` (already aligned with pasted §2 preview origin)
...
| Preview origin | `https://crm-may-branch.preview.emergentagent.com` |
| Full preview URL | `https://crm-may-branch.preview.emergentagent.com/api/pos/loyalty/redeem` |
...
- Connectivity probe (this turn): `POST https://crm-may-branch.preview.emergentagent.com/api/pos/loyalty/redeem` with empty body and no auth → **HTTP 401** (route exists, auth gate enforced). No data mutated by this probe.
