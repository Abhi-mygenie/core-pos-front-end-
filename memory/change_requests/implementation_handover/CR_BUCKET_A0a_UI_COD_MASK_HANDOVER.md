...
| Smoke screenshot of `https://bug-104-credit.preview.emergentagent.com` | ✅ Page loads, no compile-error overlay, Mygenie login screen renders |
...
### Pre-conditions
- Live URL: `https://bug-104-credit.preview.emergentagent.com`
