...
- **Source:** AUDIT-DISCOVERED — `SESSION_HANDOVER_2026_09_06_AUDIT_BASELINE_PROMPT_V08.md` §2.1
- **Jest run (excluding 3 scripts):** 591 pass / 56 fail / 647 total — log at `evidence/BASELINE-2026-09/`
- **3 fake scripts:** identified in baseline audit (CR-358-P3 `bucketReservationOps.test.js`, CR-358-P4 `roomStatusTransform.cr358p4.test.js`, `pmsService.tapeChart.cr358p4.test.js`)
- **Confidence:** CONFIRMED (Jest run evidence in `evidence/BASELINE-2026-09/`)
- **Screenshots:** N/A (test runner output)
- **Curl output:** N/A
