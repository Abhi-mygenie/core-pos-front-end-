...
- Public URL `https://bug-104-credit.preview.emergentagent.com` loads the Mygenie login page (logo, "Streamlined Hospitality. Exceptional Experience.", email/password form, LOG IN button) — confirmed via screenshot.
