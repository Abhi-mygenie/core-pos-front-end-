...
- **CR-358-P2** (New Booking S3 + Check-In S4): **QA PASS Gate 5b — 13/13 tests (100%)** — implemented 2026-09-03. 8 edits / 5 files: NewBookingPage.jsx (S3), CheckInPage.jsx (S4), pmsService.js (+getBookableRooms, getPmsReservations, createDirectReservation, pmsCheckIn), aiosellTransform.js (+fromDirectReservation, +fromPendingArrival), App.js SC-01 route re-point (owner-approved). QA: room pills(5), arrivals(4), KPIs, walk-in mode, cross-nav S3↔S4, form validation, summary sync, room-type-mismatch warning. Next: **owner Gate 6 smoke**.
- Latest handover: `memory/handover/SESSION_HANDOVER_2026_09_03_CR358P2_GATE3.md`
- Latest QA report: `test_reports/iteration_1.json`
