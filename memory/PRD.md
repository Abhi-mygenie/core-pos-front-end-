...
| Public preview URL | https://req2-req3-req4-qa.preview.emergentagent.com |
...
4. **Emergent platform preview wrapper** (`https://req2-req3-req4-qa.preview.emergentagent.com`) hosts the app inside an iframe and serves its own `<title>Loading...</title>`. Cosmetic only; the inner-iframe app shows MyGenie branding correctly. Cannot be changed from this codebase.
...
curl -sI https://req2-req3-req4-qa.preview.emergentagent.com | head -5  # expect HTTP/2 200
```
