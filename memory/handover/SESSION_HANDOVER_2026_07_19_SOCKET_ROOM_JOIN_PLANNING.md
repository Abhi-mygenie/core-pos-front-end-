...
## ⚠️ RENUMBERING NOTE (added 2026-07-19 by INTAKE agent)

**This document was originally on the `socket-issue` branch as CR-077.**
**It has been RENUMBERED to CR-082** to avoid collision with the existing CR-077 (Inventory Hierarchy Stock Transfer — Receive/Dispatch module).

| Old ID | New ID | Reason |
|---|---|---|
| CR-077 (socket-issue branch) | **CR-082** | CR-077 already registered for Inventory Transfer Receive. Different feature entirely. |

**Next agent:** When implementing this, use **CR-082** in all code markers, registry updates, and handover docs. Ignore any "CR-077" references inside this document — they refer to CR-082.
