...
| Approver | Owner (R689) |
| Medium | In-app live smoke test on preview (`https://a37272b2-067c-4073-9ba7-6d2a84b5ea1d.preview.emergentagent.com`) against preprod backend (`https://preprod.mygenie.online/`) |
