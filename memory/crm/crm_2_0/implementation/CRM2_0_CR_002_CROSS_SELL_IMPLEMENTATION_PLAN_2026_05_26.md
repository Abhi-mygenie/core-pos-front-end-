...
**Exact URL construction (CH-3):** `${process.env.REACT_APP_CRM_BASE_URL}${API_ENDPOINTS.CUSTOMER_ORDER_SUGGESTIONS}` → `https://react-python-crm.preview.emergentagent.com/api/pos/customers/order-suggestions`
