# BUG Legacy Retro Summary — BUG-017
...
Quantity Input — Amount Not Updating When Qty Is Typed (Items with Variants / Add-ons)

## 3. Original April-2026 fix narrative (from master tracker)

FIXED (Apr-2026) — `totalPrice` recomputed on qty change for customized items in `OrderEntry.updateQuantity`
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-017)
...
— End of BUG-017 Legacy Retro Summary —
