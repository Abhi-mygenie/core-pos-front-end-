# BUG Legacy Retro Summary — BUG-013
...
Service Charge Applied to Takeaway and Delivery (Should Be Dine-In and Room Only)

## 3. Original April-2026 fix narrative (from master tracker)

FIXED (Apr-2026) — SC gated by orderType (dineIn/walkIn/room only)
...
`CollectPaymentPanel.jsx`, `orderTransform.js`, `OrderEntry.jsx`
...
- Master tracker: `/app/memory/BUG_TEMPLATE.md` (row for BUG-013)
...
— End of BUG-013 Legacy Retro Summary —
