...
- **G4 rows still open** (needed before "Gate 4 GO", state 2026-09-21): ~~G4-01~~ ✓ (final pack green) · ~~G4-02~~ ✓ (D14 fixed + verified) · **G4-03** ((a)(c)(d) verified; (b) `held_fallback` chip untestable until **BQ-385-21** — backend provides a no-CM-rate sandbox date — or owner waiver; OG-PMS-033) · **G4-04** (B-7 smoke: 5 PASS, S-418 N/A → M6, **S-411 FAIL → backend D17** — fix + re-smoke or owner waiver) · **G4-06** (owner "close Gate 3") · ~~G4-07~~ ✓ (BQ-385-19 shipped + validated) · **G4-10** (owner "Gate 4 GO").
