...
- **G4 rows still open** (needed before "Gate 4 GO", state 2026-09-21): ~~G4-01~~ ✓ (final pack green) · ~~G4-02~~ ✓ (D14 fixed + verified) · **G4-03** ((a)(c)(d) verified; (b) `held_fallback`: **BQ-385-21 answered — no empty CM night exists, BE will not wipe rates** → chip ships on the enum with a synthetic unit fixture (V-M4-00); **owner waiver required to tick**; OG-PMS-033) · ~~G4-04~~ ✓ (B-7 smoke complete 2026-09-21: 6 PASS incl. S-411 after D17 fix; S-418 N/A → M6) · **G4-06** (owner "close Gate 3") · ~~G4-07~~ ✓ (BQ-385-19 shipped + validated) · **G4-10** (owner "Gate 4 GO").
