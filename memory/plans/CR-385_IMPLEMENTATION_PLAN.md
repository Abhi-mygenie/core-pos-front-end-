...
- **G4 rows still open** (needed before "Gate 4 GO"): ~~G4-01~~ ✓ (final pack green 2026-09-20 22:00), G4-02 (D14 fix or owner waiver — mitigation present in matrix #21), G4-03 (N11 boundary probes — backend sandbox help), G4-04 (B-7 smoke §S), G4-06 (owner "close Gate 3"), G4-07 (BQ-385-19 — **FE fallback accepted in §3 D-rules; owner to confirm acceptance**), G4-10 (owner "Gate 4 GO").
