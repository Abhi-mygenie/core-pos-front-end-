...
| **R31** NEW | Backend D15 (shorten re-prices at blended rate) / D16 (move recomputes GST flat) — Extend Stay figures wrong after shorten or move | BACKEND_BRIEF_CR-385_2026-09-20_FINAL_PACK.md; M4 shorten + move flows **blocked until fixed or owner waiver** (G4-03 c/d); FE displays server `charge` only, cannot mask | Backend / Owner |
