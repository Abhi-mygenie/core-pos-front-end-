...
export const AIOSELL_ENDPOINTS = {
  ...
  // P4 — wired in Phase 4 (both endpoints DELIVERED 2026-09-02 via handover_3.md — MISSING-02 RESOLVED)
  ROOM_STATUS:         '/api/v2/vendoremployee/aiosell/room-status',       // PATCH room-status/{table_id} — ✅ DELIVERED 2026-09-02
  ROOM_STATUS_BOARD:   '/api/v2/vendoremployee/aiosell/room-status-board', // GET all rooms w/ display_status — ✅ DELIVERED 2026-09-02
  // P5 — wired in Phase 5
