...
**Status:** POPULATED
**Last Updated:** 2026-06-02 (deployment reconciliation — branch `30-may` → `2-jiune-v2`; preview pod URL changed; CRM base URL reverted to production-stable `crm.mygenie.online`)
...
|---|---|---|
| `REACT_APP_BACKEND_URL` | `https://insights-phase.preview.emergentagent.com` | Emergent preview URL (2-jiune-v2 pod) |
...
| `REACT_APP_CRM_BASE_URL` | `https://insights-phase.preview.emergentagent.com/api` | CRM API endpoint (staging build 6; changed from `crm.mygenie.online/api` on 2026-06-05 per owner directive) |
