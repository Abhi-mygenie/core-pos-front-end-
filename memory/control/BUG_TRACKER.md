**Last Updated:** 2026-08-22 (BUG-340 INTAKE — Popular tab empty chips: adaptProduct receives raw API format, skips productTransform.fromAPI. P1 HIGH. 3 R5 hotspot files. Architecture fix: load in LoadingPage boot + MenuContext. Related: CR-148.)
