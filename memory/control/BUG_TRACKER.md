**Last Updated:** 2026-09-16 — **GATE 2 COMPLETE — BATCH-PMS2-1.** BUG-422 (RoomCheckInModal balancePayment useMemo L363-367 — add GST — 1 file 1 edit), BUG-423 (GuestFolioPage roomBalance L100 — FE formula — 1 file 1 edit), BUG-418 (PmsCheckoutDrawer correctedRoomBalance before CollectPaymentPanel — 1 file ~10 lines — hotspot R5 avoided). IA: `impact/BATCH_PMS2_1_BUG422_423_418_IMPACT_ANALYSIS.md`. Awaiting 5 ODs (OD-422-01, OD-423-01, OD-423-02, OD-418-01, OD-418-02) → Gate 4 GO. Impl sequence: BUG-422 → BUG-423 → BUG-418 → (then Batch 2: BUG-420 on same file RoomCheckInModal).
