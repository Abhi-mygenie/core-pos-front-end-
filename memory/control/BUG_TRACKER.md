...
|---|---|---|---|---|---|---|
| BUG-196 | Sidebar missing on 6 inventory/employee pages | P1 | LOW | **QA PASS** | 0-5b ✅ | QA 2026-07-17: 6/6 pages have Sidebar. RestaurantSettingsPage OQ pending. Ready for Owner Smoke. |
| BUG-197 | CR-072 Inventory Post-Delivery (10 gaps + QA-discovered recipe field mismatches) | P1 | HIGH | **QA PARTIAL + GATE 2 ADDENDUM** | 0-5b | QA 2026-07-17: 7/10 original fixes PASS. Recipe transforms have wrong field names (recipe_qty, recipe_unit, sub_recipe_name, subunit, prepration_time, thershold_*). Missing X-localization header. Addendum at `impact/BUG-197_IMPACT_ANALYSIS_ADDENDUM_QA.md`. Needs Gate 3 update → Gate 4 GO. |
| BUG-198 | CR-069 Employee Post-Delivery (4 original + 4 QA-discovered: email auto-fill, role PUT, role validation, X-localization) | P1 | HIGH | **QA PARTIAL + GATE 2 ADDENDUM** | 0-3 | QA 2026-07-17: all endpoints work with correct headers. 10 edits total (6 original + 4 new). OQ-4 resolved: auto-fill email. OQ-5 pending. Addendum at `impact/BUG-198_IMPACT_ANALYSIS_ADDENDUM_QA.md`. Needs Gate 3 update → Gate 4 GO. |
