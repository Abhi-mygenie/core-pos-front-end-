...
| BUG-311 | No duplicate detection (Layers 2+3; L1 deferred) | P1 | MEDIUM | **IMPLEMENTED** | 5a ✅ | `InventorySetupPanel.jsx:146` + `IngredientBulkEditor.jsx:192`. // BUG-311 |
