**Last Updated:** 2026-09-16 — **INTAKE BATCH (7 new bugs). BUG-417** (folio F&B not posting + advance ₹0, P1 HIGH), **BUG-418** (checkout drawer GST not in display — BUG-401 display gap, P1 CRITICAL), **BUG-419** (Corp/B2B position in new check-in form, P2 LOW), **BUG-420** (returning guest docs not visible in OLD modal — CR-129 gap, P1 HIGH), **BUG-421** (in-house balance shows booking total not outstanding — wrong field, P1 HIGH), **BUG-422** (old RoomCheckInModal balance_payment missing GST — BUG-410 gap, P1 CRITICAL), **BUG-423** (Guest Folio balance excludes GST — BUG-401/CR-364 display gap, P1 CRITICAL). Registry: 680 items. All at Gate 1 INTAKE.
