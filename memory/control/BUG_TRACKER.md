**Last Updated:** 2026-09-21 — **CR-385 Phase 0.5 CLOSED**: BUG-434/435/436/437/438 → **FIXED + QA-VERIFIED** (Bug Fix role, one batch, `// CR-385 M0.5 BUG-43x` markers; QA `test_reports/iteration_7.json` + `iteration_8.json` 15/15 + main-agent timing probe; report `test_reports/QA_REPORT_2026_09_21_CR385_P0_5.md`). BUG-431/432 stay DEFERRED-TO-P2, BUG-433 DEFERRED-TO-P3. Next: owner Phase 0 smoke ("Phase 0 smoke OK") → Phase 1.
