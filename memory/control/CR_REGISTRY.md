...
| **CR-363** | PMS — Night Audit Report | P1 | HIGH | **BACKEND-BLOCKED 2026-09-16.** Owner froze OD-363-01..06 (Sales=booked + Revenue=collected, F&B separate, read-only v1, sidebar, unlimited replay). Day Closure correction: room checkout cash is blended in settlement report → reconciliation needs backend split. Brief `BACKEND_BRIEF_CR363_NIGHT_AUDIT_2026_09_16.md` (`GET aiosell/night-audit?date=`) + CR-366 `revenue-summary`. Joint Gate 2 with CR-366 after endpoint probe. | 1 | NONE | MEDIUM | `change_requests/CR-363_PMS_NIGHT_AUDIT_REPORT_INTAKE.md` (updated 2026-09-16) |
| **CR-364** | PMS — Guest Folio Detail Page | P1 | HIGH | **INTAKE OPEN — UNBLOCKED. OD-01 (v1 totals only) + OD-02 (PMS folio via `rtype='RM'` branch, R6) FROZEN 2026-09-16. CIB (CR-131) comparison + CR-363/366 gap = DISTINCT. Backend brief filed (`CR364_FOLIO_PRINT` — 9 blocks, 15 Qs). Gate 2 blocked on OD-03/04/05 (next session).** | 1 | PARTIAL | MEDIUM | `change_requests/CR-364_PMS_GUEST_FOLIO_DETAIL_PAGE_INTAKE.md` (updated 2026-09-16); Investigation `CR-364_INVESTIGATION_CIB_COMPARISON.md`; Backend Brief `backend_briefs/BACKEND_BRIEF_CR364_FOLIO_PRINT_2026_09_16.md` |
...
| **CR-366** | PMS — Revenue Dashboard / Analytics | P2 | MEDIUM | **BACKEND-BLOCKED 2026-09-15 — owner froze OD-366-01 (booked+collected), OD-366-02 (F&B separate/TRevPAR), OD-366-03 (no range ceiling). Brief filed: `GET aiosell/revenue-summary` (Q-366-01..10). Gate 2 after endpoint probe. OD-366-04 open.** | 1 | NONE | MEDIUM | `change_requests/CR-366_PMS_REVENUE_DASHBOARD_ANALYTICS_INTAKE.md` · `backend_briefs/BACKEND_BRIEF_CR366_REVENUE_AGGREGATION_2026_09_15.md` |
