...
| **CR-376-FU-B** | CategoryPanel: hide categories with 0 items for active menu + `Name (count)` labels + default tab All + Popular scoped to active menu. | P2 | MEDIUM | **GATE 3 — IMPLEMENTATION PLAN COMPLETE (2026-09-26). E1–E6 (CategoryPanel.jsx E1-E3 · OrderEntry.jsx E4-E6 additive) + E7 unit test; 12-check verification matrix; R5 regression checklist. 0 blocking owner decisions. Awaiting owner "CR-376-FU-B Gate 4 GO".** | 3 | `CategoryPanel.jsx` (~20 lines) + `OrderEntry.jsx` (~5 additive lines, R5 hotspot — no Fast Lane) + NEW `__tests__/CategoryPanel.cr376fub.test.jsx`. Plan: `plans/CR-376-FU-B_IMPLEMENTATION_PLAN.md`. Impact: `impact/CR-376-FU-B_IMPACT_ANALYSIS.md`. Handover: `handover/SESSION_HANDOVER_2026_09_26_CR376_FU_B_GATE3_COMPLETE.md`. |
