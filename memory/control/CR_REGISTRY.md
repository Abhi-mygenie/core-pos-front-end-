...
| **CR-364** | PMS — Guest Folio Detail Page | P1 | HIGH | **GATE 2 — IMPACT ANALYSIS WRITTEN 2026-09-14. R11 probe PASS (get-single-order-new 200). reservation.guest + gst_tax + payments[] all confirmed. 2 NEW + 5 MOD files. Design questions D1-D5. Awaiting design → Gate 3.** | 2 | PARTIAL | MEDIUM | `change_requests/CR-364_PMS_GUEST_FOLIO_DETAIL_PAGE_INTAKE.md` (updated 2026-09-14); Investigation `CR-364_INVESTIGATION_CIB_COMPARISON.md`; Backend Brief `backend_briefs/BACKEND_BRIEF_CR364_FOLIO_PRINT_2026_09_16.md` |
