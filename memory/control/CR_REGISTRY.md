...
| **CR-364** | PMS — Guest Folio Detail Page | P1 | HIGH | **INTAKE FULLY CLOSED — DATA PATH ONLY (2026-09-14). All 5 ODs resolved. Print path split → CR-364-PRINT (BACKEND-BLOCKED). Gate 2 UNBLOCKED for data path.** | 2 | PARTIAL | MEDIUM | `change_requests/CR-364_PMS_GUEST_FOLIO_DETAIL_PAGE_INTAKE.md` (updated 2026-09-14); Investigation `CR-364_INVESTIGATION_CIB_COMPARISON.md`; Backend Brief `backend_briefs/BACKEND_BRIEF_CR364_FOLIO_PRINT_2026_09_16.md` |
