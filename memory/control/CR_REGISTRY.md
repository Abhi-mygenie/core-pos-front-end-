...
| **CR-090** | Inventory Categories — Edit & Delete — pencil + trash on category sidebar rows. DELETE endpoint CONFIRMED (3 scenarios: success/has-ingredients/franchise-locked). PUT (rename) pending OQ-1. RELATED to BUG-220 (dup check). | **P2** | MEDIUM | **GATE 2 COMPLETE** | 2 ✅ | 3 files: `constants.js`, `inventoryService.js`, `InventorySetupPanel.jsx`. ~40-50 lines. Impact Analysis: `/app/memory/impact/CR-090_IMPACT_ANALYSIS.md` |
