...
| **CR-365** | PMS — Housekeeping Workflow | P2 | MEDIUM | **INTAKE — BACKEND-BLOCKED** | 1 | PARTIAL | LARGE | hk-tasks model + employee list + push/socket needed; prerequisite fix OG-PMS-010. `change_requests/CR-365_PMS_HOUSEKEEPING_WORKFLOW_INTAKE.md` |
