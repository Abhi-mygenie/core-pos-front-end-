...
| **CR-363** | PMS — Night Audit Report | P1 | HIGH | **INTAKE CLOSED — UNBLOCKED 2026-09-11. BUG-385 resolved: `today.no_show_count` live in dashboard-kpis. All data confirmed. BLOCKED on owner ODs 363-01..06. Gate 2 ready once ODs answered.** | 1 | NONE | MEDIUM | `change_requests/CR-363_PMS_NIGHT_AUDIT_REPORT_INTAKE.md` (updated 2026-09-11) |
