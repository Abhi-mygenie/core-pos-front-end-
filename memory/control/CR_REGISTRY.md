...
| **CR-364** | PMS — Guest Folio Detail Page | P1 | HIGH | **INTAKE CLOSED — UNBLOCKED 2026-09-11. BUG-384 resolved: `room-payment` contract confirmed (`room_order_id`+`payment_amount`+`payment_mode`). Record Payment buildable. BLOCKED on owner ODs 364-01..05. Gate 2 ready once ODs answered.** | 1 | PARTIAL | MEDIUM | `change_requests/CR-364_PMS_GUEST_FOLIO_DETAIL_PAGE_INTAKE.md` (updated 2026-09-11) |
