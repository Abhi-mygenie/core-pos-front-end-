...
| **CR-366** | PMS — Revenue Dashboard / Analytics | P2 | MEDIUM | **INTAKE CLOSED — UNBLOCKED 2026-09-11 (never backend-blocked; confirmed). All data sources live. BLOCKED on owner ODs 366-01..04 (OD-366-01 = R6 mandatory). Gate 2 ready once ODs answered.** | 1 | NONE | MEDIUM | `change_requests/CR-366_PMS_REVENUE_DASHBOARD_ANALYTICS_INTAKE.md` (confirmed 2026-09-11) |
