...
| **CR-363** | PMS — Night Audit Report | P1 | HIGH | **GATE 2 — IMPACT ANALYSIS WRITTEN 2026-09-14 (joint with CR-366). R11 probe PASS (`night-audit` 200). New ODs OD-363-07/08. Awaiting combined Sidebar SC ack → Gate 3.** | 2 | NONE | MEDIUM | `change_requests/CR-363_PMS_NIGHT_AUDIT_REPORT_INTAKE.md`; `impact/CR-363_CR-366_JOINT_IMPACT_ANALYSIS.md`; Brief: `BACKEND_BRIEF_CR363_NIGHT_AUDIT_2026_09_16.md` |
...
| **CR-366** | PMS — Revenue Dashboard / Analytics | P2 | MEDIUM | **GATE 2 — IMPACT ANALYSIS WRITTEN 2026-09-14 (joint with CR-363). OD-366-04 RESOLVED (sidebar). R11 probe PASS (`revenue-summary` day/week 200). New ODs OD-366-05..08. Awaiting Sidebar SC ack → Gate 3.** | 2 | NONE | MEDIUM | `change_requests/CR-366_PMS_REVENUE_DASHBOARD_ANALYTICS_INTAKE.md` · `impact/CR-363_CR-366_JOINT_IMPACT_ANALYSIS.md` · `backend_briefs/BACKEND_BRIEF_CR366_REVENUE_AGGREGATION_2026_09_15.md` |
