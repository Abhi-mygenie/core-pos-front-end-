...
|---|---|---|---|---|---|---|---|---|
| **CR-379** | PMS Check-In — CRM Customer Link (Core) | P1 | HIGH | **GATE 3 COMPLETE (2026-09-13). Implementation Plan at `plans/CR-379_IMPLEMENTATION_PLAN.md`. 15 edit sites / 2 files (CheckInPage.jsx major, pmsService.js minor). 13 verification scenarios V-01..V-13. Awaiting Gate 4 GO for implementation.** | 3 | NONE | MEDIUM | Files: `CheckInPage.jsx` + `pmsService.js`. Badge: 4-col (Stays/LastStay/LoyaltyPts/StoreCredit) + Doc-type cards. Auto-lookup on 10 digits. Extra adults inline. Children per-input. Corporate checkbox. Amber non-blocking error. `impact/CR-379_IMPACT_ANALYSIS.md` · `plans/CR-379_DESIGN_DECISIONS.md` · `plans/CR-379_IMPLEMENTATION_PLAN.md` · `public/cr379-design-mockup.html` |
