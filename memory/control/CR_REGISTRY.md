...
| **CR-364** | PMS — Guest Folio Detail Page | P1 | HIGH | **GATE 3 — IMPLEMENTATION PLAN WRITTEN 2026-09-14. 7 files (2 NEW + 5 MOD). Option Set C. Record Payment PARKED (C1). Meal plan field (C4). 20 verification checks. Awaiting Gate 4 GO.** | 2 | PARTIAL | MEDIUM | `change_requests/CR-364_PMS_GUEST_FOLIO_DETAIL_PAGE_INTAKE.md` (updated 2026-09-14); Investigation `CR-364_INVESTIGATION_CIB_COMPARISON.md`; Backend Brief `backend_briefs/BACKEND_BRIEF_CR364_FOLIO_PRINT_2026_09_16.md` |
