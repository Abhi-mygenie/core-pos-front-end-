...
| **CR-364** | PMS — Guest Folio Detail Page | P1 | HIGH | **INTAKE FULLY CLOSED (2026-09-14). All 5 ODs resolved: OD-01=totals only v1, OD-02=PMS folio via `rtype='RM'` (R6), OD-03=RE-POINT links, OD-04=DRILL-DOWN F&B, OD-05=NO FE date limit. Gate 2 UNBLOCKED — ready for Impact Analysis.** | 2 | PARTIAL | MEDIUM | `change_requests/CR-364_PMS_GUEST_FOLIO_DETAIL_PAGE_INTAKE.md` (updated 2026-09-14); Investigation `CR-364_INVESTIGATION_CIB_COMPARISON.md`; Backend Brief `backend_briefs/BACKEND_BRIEF_CR364_FOLIO_PRINT_2026_09_16.md` |
