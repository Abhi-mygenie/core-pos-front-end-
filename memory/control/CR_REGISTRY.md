...
| **CR-105** | Smart Purchase: Show All Ingredients + Manual Add to Purchase List. Sub-A: "Show All" toggle (in-stock items visible). Sub-B: Manual "Add Item" typeahead. Spawned from investigation (B2 coverage gap). | **P2** | LOW | **INTAKE COMPLETE — 3 OQs pending owner** | 0-1 | `purchasePlanner.js`, `SmartPurchasePanel.jsx`, `AutoShoppingList.jsx`. ~30-50 lines. |
