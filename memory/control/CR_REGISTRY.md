...
| **CR-105** | Smart Purchase: Show All Ingredients + Manual Add to Purchase List. Sub-A: "Show All" toggle (in-stock items fully editable). Sub-B: Manual "Add Item" from master list only. All OQs resolved. | **P2** | LOW | **INTAKE COMPLETE — ready for Gate 2** | 0-1 ✅ | `purchasePlanner.js`, `SmartPurchasePanel.jsx`, `AutoShoppingList.jsx`. ~30-50 lines. |
