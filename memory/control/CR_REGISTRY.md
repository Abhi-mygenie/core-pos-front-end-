...
**Status:** POPULATED
**Last Updated:** 2026-09-08 — **CR-358-P5 DESIGN APPROVED + Gate 2 Ready** (design_guidelines.json · cr358-p5-v3-mockup.html). All 4 ODs locked. Backend brief filed (Q1–Q4). Next: Gate 2 Impact Analysis. · prior: 2026-09-06 (INV-PMS-CRs-363-364-366 — deep API impact analysis done, `INV_CR363_CR364_CR366_API_IMPACT_ANALYSIS.md`. CR-363 → PARTIALLY UNBLOCKED (no no-show field; balance = client-side join). CR-364 → PARTIALLY UNBLOCKED (read-only folio OK; `pos/room-payment` 403; F&B transfer list empty). CR-366 → MOSTLY UNBLOCKED (daily-sales is single-day → N calls). All `/api/v1/` order endpoints now 404 — use `/api/v2/`.) · prior: 2026-09-04 (INTAKE — 8 PMS items registered: CR-361..CR-367 post-CR-358 enhancements + CR-358-P5 Rates/No-Show. Source: `PMS_ENHANCEMENTS_FEASIBILITY_INVESTIGATION.md`. 4 BACKEND-BLOCKED (361/362/365/367), 4 unblocked (363/364/366/358-P5).) · prior: CR-358-P4 GATE 5b QA PASS — 34/34 exec tests pass + testing agent 100%. Report: `reports/QA_REPORT_CR358_P4_2026_09_04.md`. Ready for Gate 6 Owner Smoke.
...
| **CR-358-P5** | PMS Phase 5 — Rate Grid + Inventory Restrictions + Rate Restrictions (S8-C full) + Mark No-Show (S8-D) | P1 | HIGH | **GATE 3 — Implementation Plan written (2026-09-08). 8 edits (2 NEW: RatesTab.jsx, NoShowDialog.jsx). 28 checks. Awaiting Gate 4 GO.** `plans/CR-358-P5_IMPLEMENTATION_PLAN.md` | 3 | PARTIAL | MEDIUM | `impact/CR-358-P5_IMPACT_ANALYSIS.md` · `plans/CR-358-P5_IMPLEMENTATION_PLAN.md` · `design_guidelines.json` |
