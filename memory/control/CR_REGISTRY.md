...
| CR ID | Title | Priority | Risk | Status | Gate | Code reality | Blast | Notes |
|---|---|---|---|---|---|---|---|---|
| **CR-385** | PMS Front Desk — Unified Tabbed Workstation UX Revamp | **P1** | **HIGH** | **INTAKE — GATE 1 COMPLETE (2026-09-16). Option B (Tabbed Workstation) owner-selected. 7 ODs open for Gate 2. Gate 2.5 design freeze MANDATORY.** | 1 | NONE | LARGE | 4 candidate tabs: Arrivals / In-House / Departures / Room Status. Single URL `/pms/front-desk`. CheckInPage.jsx + GuestFolioPage.jsx out of scope. Hotspot: `App.js`. Sprint: pos_pms_2. Intake: `change_requests/CR-385_PMS_FRONTDESK_UNIFIED_WORKSTATION_UX_REVAMP_INTAKE.md`. Related: CR-358-P1/P3/P4, CR-362, CR-365. |
