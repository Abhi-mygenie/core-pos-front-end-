...
|---|---|---|---|---|---|---|---|---|
| **CR-379** | PMS Check-In — CRM Customer Link (Core) | P1 | HIGH | **GATE 5A IMPLEMENTED (2026-09-14). 15 edit sites applied. CheckInPage.jsx + pmsService.js. Compile CLEAN. QA handover pending.** | 5 | NONE | MEDIUM | Files: `CheckInPage.jsx` + `pmsService.js`. Badge: 4-col (Stays/LastStay/LoyaltyPts/StoreCredit) + Doc-type cards. Auto-lookup on 10 digits. Extra adults inline. Children per-input. Corporate checkbox. Amber non-blocking error. `impact/CR-379_IMPACT_ANALYSIS.md` · `plans/CR-379_DESIGN_DECISIONS.md` · `plans/CR-379_IMPLEMENTATION_PLAN.md` · `public/cr379-design-mockup.html` |
