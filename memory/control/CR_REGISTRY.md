...
| **CR-363** | PMS — Night Audit Report | P1 | HIGH | **GATE 2 — OD DECISIONS RECORDED 2026-09-14. OD-363-07: show+badge ✅ OD-363-08: ship — + BE null-brief ✅. OD-366-08 OPEN. Design options pending. Sidebar SC ack pending → Gate 3 ready after design + OD-366-08.** | 2 | NONE | MEDIUM | `change_requests/CR-363_PMS_NIGHT_AUDIT_REPORT_INTAKE.md`; `impact/CR-363_CR-366_JOINT_IMPACT_ANALYSIS.md`; Brief: `BACKEND_BRIEF_CR363_NIGHT_AUDIT_2026_09_16.md` |
...
| **CR-366** | PMS — Revenue Dashboard / Analytics | P2 | MEDIUM | **GATE 2 — OD DECISIONS RECORDED 2026-09-14. OD-366-05: no cache ✅ OD-366-06: no v1 ✅ OD-366-07: 7D default ✅ OD-366-08: OPEN. Design options pending. Sidebar SC ack pending → Gate 3 ready after design + OD-366-08.** | 2 | NONE | MEDIUM | `change_requests/CR-366_PMS_REVENUE_DASHBOARD_ANALYTICS_INTAKE.md` · `impact/CR-363_CR-366_JOINT_IMPACT_ANALYSIS.md` · `backend_briefs/BACKEND_BRIEF_CR366_REVENUE_AGGREGATION_2026_09_15.md` |
