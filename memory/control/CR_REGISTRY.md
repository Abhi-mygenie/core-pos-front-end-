...
| **CR-363** | PMS — Night Audit Report | P1 | HIGH | **BACKEND-UNBLOCKED 2026-09-14. `aiosell/night-audit` SHIPPED. All Q-363-01..08 answered. Same `PmsRevenueMetricsService` as CR-366 (R6 ✅). `room_status_close` = current board only (no historical OOO — label in UI). Ready for joint Gate 2 Impact Analysis with CR-366.** | 2 | NONE | MEDIUM | `change_requests/CR-363_PMS_NIGHT_AUDIT_REPORT_INTAKE.md`; Brief: `BACKEND_BRIEF_CR363_NIGHT_AUDIT_2026_09_16.md` |
...
| **CR-366** | PMS — Revenue Dashboard / Analytics | P2 | MEDIUM | **BACKEND-UNBLOCKED 2026-09-14. `aiosell/revenue-summary` SHIPPED. All Q-366-01..13 answered. No range ceiling confirmed. `booking_payment_type` key. Live compute (no cache). Ready for joint Gate 2 Impact Analysis with CR-363.** | 2 | NONE | MEDIUM | `change_requests/CR-366_PMS_REVENUE_DASHBOARD_ANALYTICS_INTAKE.md` · `backend_briefs/BACKEND_BRIEF_CR366_REVENUE_AGGREGATION_2026_09_15.md` |
