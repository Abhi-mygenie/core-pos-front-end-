...
| **CR-363** | PMS — Night Audit Report | P1 | HIGH | **GATE 3 — IMPLEMENTATION PLAN WRITTEN 2026-09-14. Joint plan with CR-366. 8 files specced (4 NEW, 4 MOD). Verification Matrix included. Awaiting Gate 4 GO.** | 2 | NONE | MEDIUM | `change_requests/CR-363_PMS_NIGHT_AUDIT_REPORT_INTAKE.md`; `impact/CR-363_CR-366_JOINT_IMPACT_ANALYSIS.md`; Brief: `BACKEND_BRIEF_CR363_NIGHT_AUDIT_2026_09_16.md` |
