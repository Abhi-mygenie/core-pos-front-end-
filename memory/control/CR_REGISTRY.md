...
| **Status** | **GATE 2 IMPACT ANALYSIS COMPLETE — Gate 3 BLOCKED on 8 owner decisions (OD-01→OD-08)** |
| **Sprint** | pos_5_2 |
| **Gate** | 2 ✅ |
...
| **Missing backend APIs** | 5 endpoints (local-reservations, public self-CI GET, public self-CI POST, direct-reservation, dashboard-KPIs) |
| **Owner decisions (OD)** | OD-01: modal-vs-route, OD-02: OTA check-in linkage, OD-03: AIOSELL setup location, OD-04: room mapping UI location, OD-05: self CI in MVP?, OD-06: save-as-booking API, OD-07: HK/OOO state storage, OD-08: meal plan decode |
| **Conflicts found** | RoomCheckInModal.jsx (HIGH — recently modified by CR-350/BUG-351/BUG-360), Sidebar.jsx (BUG-361 pattern must be preserved), DashboardPage.jsx (hotspot, CONDITIONAL on OD-01) |
| **Files WILL change** | App.js, Sidebar.jsx, api/constants.js, 7 new service/transform files, 9 new PMS page components (DashboardPage.jsx CONDITIONAL on OD-01) |
| **Files WILL NOT touch** | CollectPaymentPanel.jsx, OrderEntry.jsx, orderTransform.js, all financial/report files |
| **Next** | Gate 3 Implementation Plan — BLOCKED until OD-01→OD-08 answered by owner + backend confirms: (1) does ROOM_CHECK_IN link Online check-ins to aiosell_reservations?, (2) does checkout trigger AIOSELL inventory push? |
