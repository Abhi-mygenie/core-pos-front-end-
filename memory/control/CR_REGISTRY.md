...
| **CR-358-P5** | PMS Phase 5 — Rate Grid + Inventory Restrictions + Rate Restrictions (S8-C full) + Mark No-Show (S8-D) | P1 | HIGH | **IMPLEMENTED (Gate 5a — 2026-09-08). 8 edits (2 NEW: RatesTab.jsx, NoShowDialog.jsx). webpack 0 errors. Awaiting Gate 5b QA.** `plans/CR-358-P5_IMPLEMENTATION_PLAN.md` | 3 | PARTIAL | MEDIUM | `impact/CR-358-P5_IMPACT_ANALYSIS.md` · `plans/CR-358-P5_IMPLEMENTATION_PLAN.md` · `design_guidelines.json` |
