...
**Status:** POPULATED
**Last Updated:** 2026-09-11 — **INVESTIGATION: Backend reply processed (BE_REPLY_FE_VALIDATION_PACK_2026_09_10).** BUG-384 CLOSED (was FE contract error, not permission gap). BUG-385 CLOSED (no_show_count shipped). CR-163 GAP1+GAP2 unblocked. CR-162 registry drift corrected (actual Gate 5a). CR-363 fully unblocked. backend-briefs.html validated: CR-362/CR-365/CR-358 NOT present — briefs still need writing. 3 backend questions still unanswered: restrictions[] schema, mark-no-show state rules, checkout inventory release.
