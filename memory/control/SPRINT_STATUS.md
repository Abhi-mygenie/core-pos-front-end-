...
| Item | Status |
|---|---|
| **CR-390** | **GATE_1_INTAKE 2026-09-26 — BRAINSTORM MODE.** Repeat PMS v2.0 exercise (real routes + dummy data → PDF) for M1 POS Core · M2 Menu & Setup · M3 Inventory & Recipes · M4 Expenses & Staff · M5a/b/c Reports · M6 PMS regen (~90–100 screens) via committed pipeline. **OD-390-01…08 OPEN** — lock in order, 01 (data strategy) first. Gate 2 blocked until all locked. Zero code. Intake `change_requests/CR-390_MODULES_SCREEN_REFERENCE_PDF_ALL_MODULES_INTAKE.md`. |
