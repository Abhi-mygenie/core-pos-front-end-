...
| OG-PMS-019 | P2 | **BACKEND — to include in BQ-385-02** | LR rows carry `balance_payment` but value is inconsistent (₹900 vs ₹950 for identical folios) and excludes F&B/room orders. FE must keep N folio calls for true balance. Evidence: `evidence/CR-385/CR-385_balance_compare.json`. | Backend brief on CR-385 Gate 2 close |
