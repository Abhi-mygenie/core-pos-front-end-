...
| OG-PMS-027 | P2 | **OPEN — backend ask BQ-385-19** | `nights_detail` is response-only (calendar extend); not on the LR list `charge`, check-in or folio → per-night lines vanish on reload. | Backend |
